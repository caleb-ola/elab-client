      ...
      <div className="container py-5">
        <div className="terms__card p-3 p-md-5 mx-auto">
          <div className="p-2 p-md-5">
            <div>
              <h6 className="terms__card--subhead">1. Introduction</h6>
              <p className="">
                Welcome to
                {' '}
                <strong>Ennovate Lab</strong>
                .
                {' '}
                <strong>Ennovate Lab</strong>
                {' '}
                ...
                <strong>“Terms”</strong>
                ) govern all use of our Service and together
            ...
            <div>
              <h6 className="terms__card--subhead pt-3 pb-1">2. Definitions</h6>
              <p className="">
                <strong>SERVICE</strong>
                {' '}
                means the ennovatelab.com website operated by Ennovate Lab.
                {' '}
                <br />
              </p>
              {' '}
            ...
            <div>
              <h6 className="terms__card--subhead pt-3 pb-1">
            ...
            <div>
              ...
              <p className="m-0"><strong>i. Personal Data</strong></p>
              <p>
                While using our Service, we may ask you to provide us with certain
                personally identifiable information that can be used to contact or
                identify you (“Personal Data”). Personal identifiable information
              ...
              <p className="m-0"><strong>ii. Usage Data</strong></p>
              <p>
              ...
              <p>
                ...
                of your visit, the time spent on those pages, unique device identifiers
              ...
              <p className="m-0"><strong>iii. Location Data</strong></p>
              <p>
                We may use and store information about your location if you give us permission to
                do so (
                <strong>“Location Data”</strong>
                ). We use this data to provide features of our Service and
              ...
              <p className="m-0"><strong>iv. Tracking Cookies Data</strong></p>
              <p>
              ...
              <p className="m-0"><strong>v. Other Data</strong></p>
              <p>
                While using our Service, we may also collect the following information:
                sex, age, date of birth, citizenship, registration at the place of residence and
                actual address, telephone number (work, mobile), information on marital status,
            ...
            <div>
              ...
              <p>
                Ennovate Lab uses the collected data for various purposes:
              </p>
              <ul>
            ...
            <div>
              ...
              <p>
                ...
                your Personal Data to the extent necessary to comply with our legal obligations
            ...
            <div>
              ...
              <p>
                If you are located outside Nigeria and choose to provide information to us,
              ...
              <p>
                Ennovate Lab will take all the steps reasonably necessary to ensure that
            ...
            <div>
              ...
              <p className="m-0"><strong>Disclosure for Law Enforcement.</strong></p>
              <p>
              ...
              <p className="m-0"><strong>Business Transcation</strong></p>
              {/* <h6>Business Transcation</h6> */}
              <p>
                If we or our subsidiaries are involved in a merger,
                acquisition or asset sale, your Personal Data may be transferred.
              </p>
              <p className="m-0"><strong>Other cases. We may disclose your information also:</strong></p>
              <ul>
            ...
            <div>
              <h6 className="terms__card--subhead pt-3 pb-1">
                10. Your Data Protection Rights under the  Nigeria Data Protection Regulation (NDPR)
              </h6>
              <p>
                If you are a Nigerian resident, you are entitled to learn what data we
              ...
              <p className="m-0"><strong>i. What personal information do we have about you? If you make this request, we will return to you:</strong></p>
              <ul>
              ...
              <p>
                Please note, that you are entitled to ask us to provide you with this information up
              ...
              <p className="">
                <strong>
                  ii.  To delete your personal information. If you make this request, we will delete
                  the personal
                  information we hold about you as of the date of your request from our records and
                  direct any service providers to do the same. In some cases, deletion may be
                  accomplished through de-identification of the information. If you choose to
                  delete your personal information, you may not be able to use certain
              ...
              <p className="m-0">
                <strong>
                  iii.  To stop selling your personal information. We don’t sell
                  or rent your personal information to any third parties for any purpose. We do not
                  sell your personal information for monetary consideration.
                  {' '}
                </strong>
              </p>
              <p>
                You are the only owner of your Personal Data and can request disclosure or
                deletion at any time.
              </p>
              <p>
                To exercise your Nigeria data protection rights described above, please send
                your request(s) by
                {' '}
                <strong> email: ennovatelab@gmail.com.</strong>
                {' '}
              </p>
              <p>
                Your data protection rights, described above, are covered by the NDPR,
                short for the  Nigeria Data Protection Regulation.
                To find out more, visit the official National Information Technology
                Development Agency (NITDA) website. The NDPR took effect on 25/01/2019
                {' '}
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p>
                ...
                use cookies to inform, optimise and serve ads based on your
            ...
            <div>
              ...
              <p>
                ...
                is provided directly to our third-party payment processors whose use of your
                ...
                Council, which is a joint effort of brands like Visa, and Mastercard. PCI-DSS
            ...
            <div>
              ...
              <p>
                ...
                {' '}
                <a href="mailto:ennovatelab@gmail.com" className="term__Card--link fw-bold">ennovatelab@gmail.com</a>
              </p>
            </div>
          </div>
        </div>
