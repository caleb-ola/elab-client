      ...
      <div className="container py-5">
        <div className="terms__card p-3 p-md-5 mx-auto">
          <div className="p-2 p-md-5">
            <div>
              <h6 className="terms__card--subhead">
                1. Introduction
              </h6>
              <p className="terms__card--text ">
                Welcome to Ennovate Lab (“Company”, “we”, “our”, “us”)!
              </p>
              <p>
                These Terms of Service (“Terms”, “Terms of Service”) govern your
                use of our website located at
                {' '}
                <strong>ennovatelab.com</strong>
                (together or individually “Service”) operated by Ennovate Lab.
              </p>
              <p>
              ...
              <p>
                ...
                use the Service, but please let us know by emailing at hello@ennovatelab.com
            ...
            <div>
              ...
              <p className="terms__card--text ">
                ...
                opt out of receiving any,
                or all, of these communications from us by following the unsubscribe link or by
                emailing at hello@ennovatelab.com.
              </p>
            </div>
            <div>
              <h6 className="terms__card--subhead">
              ...
              <p className="terms__card--text ">
                ...
                Purchase including but not limited to, your credit or debit card number,
                the expiration date of your card, your billing address,
            ...
            <div>
              ...
              <p className="terms__card--text ">
                ...
                for a Promotion conflict with these Terms of Service, Promotion
                rules will apply.
              </p>
            </div>
            <div>
              ...
              <p className="terms__card--text ">
                We issue refunds for Contracts within 30 days of
            ...
            <div>
              ...
              <ol type="i">
                ...
                <li>
                  {' '}
                  Use any robot, spider, or other automatic devices, process, or means to
                ...
                <li>
                  ...
                  or disrupt any parts of Service, the server on which Service
            ...
            <div>
              ...
              <p className="terms__card--text ">
                ...
                and functionality are and will remain the exclusive property of Ennovate Lab and
                its licensors. Service is protected by copyright, trademark, and other laws of
                foreign countries. Our trademarks may not be used in connection with any
                product or service without the prior written consent of Ennovate Lab.
              </p>
              <p className="terms__card--text ">
                You are responsible for maintaining the confidentiality of your account and
                password, including but not limited to the restriction of access to your
            ...
            <div>
              ...
              <p className="terms__card--text ">
                You may provide us either directly at hello@ennovatelab.com or via third-party
                ...
                acquire or assert any intellectual property right or other rights, title or
                ...
                transferable, irrevocable, free-of-charge, sub-licensable, unlimited and perpetual
            ...
            <div>
              ...
              <p className="terms__card--text ">
                ...
                are not owned or controlled by Ennovate Lab.
              </p>
              <p>
                Ennovate Lab has no control over and assumes no responsibility for the content,
            ...
            <div>
              ...
              {' '}
              <p>
                THE FOREGOING DOES NOT AFFECT ANY WARRANTIES WHICH CAN NOT BE EXCLUDED
            ...
            <div>
              ...
              <p className="terms__card--text ">
                ...
                IF ANY, WHETHER OR NOT LITIGATION OR ARBITRATION IS INSTITUTED), WHETHER IN
                AN ACTION OF CONTRACT, NEGLIGENCE, OR OTHER TORTIOUS ACTION, OR ARISING OUT OF OR
                ...
                BE LIMITED TO THE AMOUNT PAID FOR THE
                PRODUCTS AND/OR SERVICES, AND UNDER NO CIRCUMSTANCES WILL THERE BE CONSEQUENTIAL OR
                PUNITIVE DAMAGES. SOME STATES DO NOT ALLOW THE EXCLUSION OR LIMITATION OF PUNITIVE,
                INCIDENTAL OR CONSEQUENTIAL DAMAGES, SO THE PRIOR LIMITATION OR EXCLUSION MAY NOT
                APPLY TO YOU.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="terms__card--text ">
                ...
                which governing law applies to the agreement without regard to its conflict
                of law provisions.
              </p>
              {' '}
              <p>
            ...
            <div>
              ...
              <p className="terms__card--text ">
                ...
                or material we provide via Service, in our sole discretion without notice.
                ...
                access to some parts of Service, or the entire Service, to users,
            ...
            <div>
              ...
              <p className="terms__card--text ">
                ...
                or provision under Terms shall not constitute a waiver of such right or provision.
              </p>
              {' '}
              <p>
            ...
            <div>
              ...
              <p>
                ...
                support by email:
                {' '}
                <a href="mailto:hello@ennovatelab.com" className="term__Card--link fw-bold">hello@ennovatelab.com.</a>
              </p>
            </div>
          </div>
        </div>
