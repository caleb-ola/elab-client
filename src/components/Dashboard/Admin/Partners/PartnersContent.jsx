      ...
      <table className="w-100 text-start px-5 mx-2 mx-lg-5">
        <thead>
          <tr className="fw-bold">
            ...
            <th className="pe-4">Partner&apos;s logo</th>
                  ...
                  Data[1].map((item, index) => (
                    <tr key={item.id}>
                      ...
                      <td className="text-end">
                        <Link to="/dashboard/admin/edit-partners/:slug">
                          <span
    ...
    <div className="content px-4">
      ...
      <div className="row content__header align-items-center mb-5">
        <div className="col-md-6 p-0 text-center text-md-start">
          <h4 className="m-0">Partners</h4>
        </div>
        <div className="col-md-6 p-0 text-center text-md-end">
          <Link to="/dashboard/admin/add-partners" className="link px-4 py-2 text-decoration-none fw-bold">Add a Partner</Link>
        </div>
      </div>
