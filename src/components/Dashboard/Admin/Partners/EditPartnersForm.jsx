      ...
      <div className="content__card w-100 p-5">
        <form className="content__form mx-5">
          <div className="row py-2">
            ...
            <input type="text" className="name p-3 my-2 content__form--input content__form--input " id="name" required />
          </div>
          <div className="row py-2">
            <label className="p-0 fw-bold" htmlFor="email">
              Partner&apos;s logo
            </label>
            <input type="file" className="name p-3 my-2 contact__form--input " id="name" required />
          </div>
...
export default EditPartnersForm;
