    ...
    <div className="content px-4">
      ...
      <div className="row content__header align-items-center mb-5">
        <div className="col-md-6 p-0 text-center text-md-start">
          <h4 className="m-0">Add a Workspace plan</h4>
        </div>
      ...
      <div className="content__card w-100 p-5">
        <form className="content__form mx-5" onSubmit={Submit}>
          ...
          <div className="py-2">
            ...
            <input type="number" className="name p-3 my-2 content__form--input " placeholder="Price per hour for cowork plan" id="price" value={price} onChange={(e) => setPrice(e.target.value)} />
          </div>
          <div className="row ps-2 py-2 content__form--row">
            <div className="col-md-6 p-0 text-start ps-md-1 py-2">
              ...
              <br />
              <input type="number" className="name p-3 my-2 content__form--inputr w-100 " placeholder="Discount in percentage" id="dicount" value={discount} onChange={(e) => setDiscount(e.target.value)} required />
            </div>
