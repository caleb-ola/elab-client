    ...
    axios.get('https://elab-api.herokuapp.com/api/v1/projects').then(
      (response) => {
        ...
        if (response.data.data.length === 0) {
          setBody(
            <DashboardEmpty header="No Project" subtext="Projects are yet to be added, proceed to add a new project." />,
          );
        } else {
          setBody(
                        ...
                        response.data.data.map((item, index) => (
                          <tr key={item.id}>
                            ...
                            <td className="text-end">
                              <Link to={`/dashboard/admin/edit-projects/${item.slug}`}>
                                <span
                                      ...
                                      <div className="modal-content">
                                        ...
                                        <div className="modal-footer  border-0">
                                          ...
                                          <button
                                            ...
                                            // eslint-disable-next-line no-use-before-define
                                            onClick={() => DeleteProject(item.slug)}
                                            data-bs-dismiss="modal"
                                          >
                                            Confirm Delete
                                          </button>
    ...
    <div className="content px-4">
      ...
      <div className="row content__header align-items-center mb-5">
        ...
        <div className="col-md-6 p-0 text-center text-md-end">
          <Link to="/dashboard/admin/add-projects" className="link px-4 py-2 text-decoration-none fw-bold">Add a Project</Link>
        </div>
      </div>
