      ...
      <div className="content__card w-100 p-5">
        <form className="content__form mx-5">
          <div className="row py-2">
            ...
            <input type="text" className="name p-3 my-2 content__form--input " id="name" />
          </div>
          <div className="row py-2">
            <label className="p-0 fw-bold" htmlFor="email">
              Impact in words
            </label>
            <textarea name="" className="content__form--input my-2 p-3" id="" cols="30" rows="10" />
